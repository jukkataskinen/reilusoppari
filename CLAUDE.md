...
**Vaihe 0 – Runko (1–2 sessiota).** Next.js + PWA, Supabase-migraatio, Auth0 passwordless, `lib/esinetti/` mock + oikea client, asiakirjojen renderöinti `src/documents/`, CI. DoD: kirjautuminen, asunnon luonti, renderöinti palauttaa PDF:n.
...
4. **Vuokrasopimuksen juridinen sisältö** (AHVL 481/1995): kirjoita tai tarkista `src/documents/` sopimuksen ja katselmuspöytäkirjojen tekstit. Vastapuoli on kuluttaja – harkitse juristin tarkistusta kertaluonteisesti.
